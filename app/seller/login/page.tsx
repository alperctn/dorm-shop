        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-black">
            ...
            <div className="w-full max-w-md bg-zinc-900/50 border border-white/10 rounded-2xl p-8 backdrop-blur-xl relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-2">Satıcı Girişi</h1>
                    <p className="text-zinc-400 text-sm">Satıcı paneline erişmek için giriş yapın.</p>
                </div>
                ...
                <div className="mt-6 text-center text-sm text-zinc-500">
                    Hesabın yok mu?{" "}
                    <Link href="/seller/register" className="text-purple-400 hover:text-purple-300">
                        Başvuru Yap
                    </Link>
                </div>
            </div>
